        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-2xl text-white tracking-tight">MediPredict AI</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/medicine" className="hover:text-blue-400 transition-colors">Medicine Identifier</Link></li>
              <li><Link to="/mental-health" className="hover:text-blue-400 transition-colors">Mental Health</Link></li>
            </ul>
          </div>
